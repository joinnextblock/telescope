...
import { BLOCKS_IN_LUNAR_CYCLE, LUNAR_CYCLES, LUNAR_PHASES, BLOCKS_IN_LUNAR_PHASE } from "./constants";
...
export class Lunar extends Delta {
  ...
  get_cycle_index(): number {
    const lunar_cycle_index = Math.floor((this.get_position_in_cycle() * LUNAR_CYCLES.length) / BLOCKS_IN_LUNAR_CYCLE);
